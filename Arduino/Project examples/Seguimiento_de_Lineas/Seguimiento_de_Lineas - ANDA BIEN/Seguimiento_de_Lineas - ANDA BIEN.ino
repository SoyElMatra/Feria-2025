...
#define SensorMiddle  2   //input pin of middle sensor
...
#define Rpwm_pin  9    //pin of controlling speed---- ENA of motor driver board
...
int pinRB=5;            //pin of controlling diversion----IN3 of motor driver board
int pinRF=6;            //pin of controlling diversion----IN4 of motor driver board
unsigned char Lpwm_val =150;//the speed of left wheel at 180 in initialization
unsigned char Rpwm_val = 150;//the speed of right wheel at 180 in initialization
