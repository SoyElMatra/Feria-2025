...
#define Rpwm_pin  9    //pin of controlling speed---- ENB of motor driver board
int pinLB=7;             //pin of controlling turning---- IN1 of motor driver board
int pinLF=8;             //pin of controlling turning---- IN2 of motor driver board
int pinRB=5;            //pin of controlling turning---- IN3 of motor driver board
int pinRF=6;            //pin of controlling turning---- IN4 of motor driver board
...
int servopin=11;              //defining digital port pin 3, connecting to signal line of servo motor
int myangle;                //defining variable of angle
int pulsewidth;              //defining variable of pulse width
unsigned char DuoJiao=80;    //initialized angle of motor at 60°
